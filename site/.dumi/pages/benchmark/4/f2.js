(function (global, factory) {
	...
	***************************************************************************** */
	...
	// weixin miniprogram
	// @ts-ignore
	var isWx = (typeof wx === "undefined" ? "undefined" : _typeof$1(wx)) === 'object' && typeof wx.getSystemInfoSync === 'function';
	// ant miniprogram
	// @ts-ignore
	var isMy = (typeof my === "undefined" ? "undefined" : _typeof$1(my)) === 'object' && typeof my.getSystemInfoSync === 'function';
	// in node
	// @ts-ignore
	var isNode = (typeof global === "undefined" ? "undefined" : _typeof$1(global)) && !(typeof window === "undefined" ? "undefined" : _typeof$1(window));
	...
	var requestAnimationFrame$1 = (typeof window === "undefined" ? "undefined" : _typeof$1(window)) === 'object' && window.requestAnimationFrame ? window.requestAnimationFrame : function (fn) {
	  ...
	  _createClass$1(Canvas, [{
	    ...
	    value: function draw() {
	      ...
	      var drawInner = function drawInner() {
	        _this2.set('animateHandler', requestAnimationFrame$1(function () {
	...
	function layoutNodeImpl(node, parentMaxWidth, /*css_direction_t*/parentDirection) {
	  ...
	  node.layout[leading[mainAxis]] += getLeadingMargin(node, mainAxis) + getRelativePosition$1(node, mainAxis);
	  node.layout[trailing[mainAxis]] += getTrailingMargin(node, mainAxis) + getRelativePosition$1(node, mainAxis);
	  node.layout[leading[crossAxis]] += getLeadingMargin(node, crossAxis) + getRelativePosition$1(node, crossAxis);
	  node.layout[trailing[crossAxis]] += getTrailingMargin(node, crossAxis) + getRelativePosition$1(node, crossAxis);
	...
	function renderShape(component, children, animate) {
	  ...
	  var renderElement = animate !== false ? compareElement(shapeElement, lastElement) : shapeElement;
	...
	var requestAnimationFrame$2 = (typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && window.requestAnimationFrame ? window.requestAnimationFrame : function (fn) {
	  return setTimeout(fn, 16);
	};
	var cancelAnimationFrame$1 = (typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && window.cancelAnimationFrame ? window.cancelAnimationFrame : function (number) {
	...
	var Adjust = /** @class */ (function () {
	    ...
	    Adjust.prototype.getDimValues = function (mergedData) {
	        ...
	        dims.forEach(function (dim) {
	            ...
	            // 在每个维度上，所有的值
	            dimValuesMap[dim] = valuesOfKey(mergedData, dim).sort(function (v1, v2) { return v1 - v2; });
	        });
	...
	***************************************************************************** */
	...
	var Symmetric = /** @class */ (function (_super) {
	        ...
	        return map(groupDataArray, function (dataArray) {
	            return map(dataArray, function (data) {
	                ...
	                if (isArray(yValue)) {
	                    ...
	                    return _assign(_assign({}, data), (_a = {}, _a[yField] = map(yValue, function (y) { return off_1 + y; }), _a));
	                }
	                // 非数组处理逻辑
	    ...
	    Symmetric.prototype.getXValuesMaxMap = function (mergeData) {
	        ...
	        var _a = this, xField = _a.xField, yField = _a.yField;
	        // 根据 xField 的值进行分组
	        var groupDataArray = groupBy(mergeData, function (data) { return data[xField]; });
	        // 获取每个 xField 值中的最大值
	        return mapValues(groupDataArray, function (dataArray) { return _this.getDimMaxValue(dataArray, yField); });
	    };
	    Symmetric.prototype.getDimMaxValue = function (mergeData, dim) {
	        // 所有的 value 值
	        var dimValues = map(mergeData, function (data) { return get(data, dim, []); });
	...
	var Geometry = /*#__PURE__*/function (_Selection) {
	  ...
	  _createClass(Geometry, [{
	    ...
	    key: "willReceiveProps",
	    value: function willReceiveProps(nextProps) {
	      _get$1(_getPrototypeOf(Geometry.prototype), "willReceiveProps", this).call(this, nextProps);
	    ...
	    value: function render() {
	      ...
	      return jsx("group", null, jsx("group", {
	        ...
	        return jsx("group", {
	          ...
	          attrs: _objectSpread(_objectSpread({}, itemMarkerStyle), {}, {
	            fill: record.color
	          })
	          ...
	          attrs: _objectSpread(_objectSpread(_objectSpread({}, defaultStyle$1.nameStyle), nameStyle), {}, {
	            text: value ? "".concat(name).concat(joinString) : name
	          })
	        }), jsx("text", {
	          attrs: _objectSpread(_objectSpread(_objectSpread({}, defaultStyle$1.valueStyle), valueStyle), {}, {
	            text: value
	          })
	        })));
	      }))), jsx("polygon", {
	        ...
	        style: _objectSpread(_objectSpread({
	          left: x,
	          top: coordBottom
	        }, defaultStyle$1.xTipBackground), xTipBackground),
	        attrs: _objectSpread(_objectSpread({}, defaultStyle$1.xTipBackground), xTipBackground)
	      }, jsx("text", {
	        attrs: _objectSpread(_objectSpread(_objectSpread({}, defaultStyle$1.xTipTextStyle), xTipTextStyle), {}, {
	        ...
	        style: _objectSpread(_objectSpread({
	          left: coordLeft,
	          top: y
	        }, defaultStyle$1.yTipBackground), yTipBackground),
	        attrs: _objectSpread(_objectSpread({}, defaultStyle$1.yTipBackground), yTipBackground)
	      }, jsx("text", {
	        attrs: _objectSpread(_objectSpread(_objectSpread({}, defaultStyle$1.yTipTextStyle), yTipTextStyle), {}, {
